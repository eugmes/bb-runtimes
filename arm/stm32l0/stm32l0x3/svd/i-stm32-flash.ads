...
package Interfaces.STM32.Flash is
   ...
   subtype ACR_LATENCY_Field is Interfaces.STM32.Bit;
   ...
   subtype ACR_DISAB_BUF_Field is Interfaces.STM32.Bit;
   subtype ACR_PRE_READ_Field is Interfaces.STM32.Bit;
   ...
   type ACR_Register is record
      ...
      --  Disable Buffer
      DISAB_BUF     : ACR_DISAB_BUF_Field := 16#0#;
   ...
   for ACR_Register use record
      ...
      DISAB_BUF     at 0 range 5 .. 5;
      PRE_READ      at 0 range 6 .. 6;
      Reserved_7_31 at 0 range 7 .. 31;
   end record;

   subtype PECR_PELOCK_Field is Interfaces.STM32.Bit;
   subtype PECR_PRGLOCK_Field is Interfaces.STM32.Bit;
   subtype PECR_OPTLOCK_Field is Interfaces.STM32.Bit;
   subtype PECR_PROG_Field is Interfaces.STM32.Bit;
   subtype PECR_DATA_Field is Interfaces.STM32.Bit;
   subtype PECR_FTDW_Field is Interfaces.STM32.Bit;
   subtype PECR_ERASE_Field is Interfaces.STM32.Bit;
   subtype PECR_FPRG_Field is Interfaces.STM32.Bit;
   subtype PECR_PARALLELBANK_Field is Interfaces.STM32.Bit;
   subtype PECR_EOPIE_Field is Interfaces.STM32.Bit;
   subtype PECR_ERRIE_Field is Interfaces.STM32.Bit;
   subtype PECR_OBL_LAUNCH_Field is Interfaces.STM32.Bit;
   ...
   subtype SR_ENDHV_Field is Interfaces.STM32.Bit;
   subtype SR_READY_Field is Interfaces.STM32.Bit;
   ...
   subtype SR_NOTZEROERR_Field is Interfaces.STM32.Bit;
   subtype SR_FWWERR_Field is Interfaces.STM32.Bit;
   ...
   subtype OBR_RDPRT_Field is Interfaces.STM32.Byte;
   subtype OBR_SPRMOD_Field is Interfaces.STM32.Bit;
   subtype OBR_BOR_LEV_Field is Interfaces.STM32.UInt4;
   ...
   type OBR_Register is record
      ...
      --  unspecified
      Reserved_20_31 : Interfaces.STM32.UInt12;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype WRPR_WRP_Field is Interfaces.STM32.UInt16;
   ...
   type Flash_Peripheral is record
      ...
      PEKEYR  : aliased Interfaces.STM32.UInt32;
      --  Program memory key register
      PRGKEYR : aliased Interfaces.STM32.UInt32;
      ...
      pragma Volatile_Full_Access (OBR);
      --  Write protection register
      WRPR    : aliased WRPR_Register;
      pragma Volatile_Full_Access (WRPR);
   end record
     with Volatile;
